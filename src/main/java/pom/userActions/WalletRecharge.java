...
//4. Edit Project	
	...
	private WebElement clickOnEditProject; //Xpath 2 - //div[@class='dropdown-menu dropdown-menu-right show']//a[@class='dropdown-item modal-remote-form-link'][normalize-space()='Edit Project']
