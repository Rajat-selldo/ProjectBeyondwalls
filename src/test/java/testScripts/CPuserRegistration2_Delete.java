...
public class CPuserRegistration2_Delete extends BaseTest {
...
//Run login with same signed up CP user then run the following script 
	...
	@Test
	public void cpOnboardingwithNew2() throws InterruptedException, IOException, FindFailed {
//Run login with same signed up CP user then run the following script 
		cpRegistration();
		logIn();
		Cpregistration register = new Cpregistration(driver);
		...
		register.uploads(); // System.getProperty("user.dir")+  		// waitUntilClickable(uploads).click();
